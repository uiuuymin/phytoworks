...
| 용어 | 의미 | 상태 및 주의사항 |
| --- | --- | --- |
| **Product** | 쇼핑몰에서 조회하고 구매할 수 있는 식물·농업 관련 판매 항목 | `Proposed` — 최종 속성과 재고 규칙은 TBD |
...
| **Customer** | 장바구니·주문·결제의 주체가 되는 사람 또는 식별 가능한 방문자 | `TBD` — 로그인 회원, 비회원 또는 세션 기반 범위를 아직 결정하지 않음 |
